		...
		<div class="row"
			...
			<form action="./RemoveProductSrv" method="post"
				...
				<div style="font-weight: bold;" class="text-center">
					<h3 style="color: black;">Product Deletion Form</h3>
					<%
					if (message != null) {
					%>
					<p style="color: blue;">
				...
				<div class="row">
					...
					<div class="col-md-6 text-center">
						<button type="submit" class="btn btn-danger" style="background-color:#CC2A2E;border-color:black;border-radius:100px;font-weight:500;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);">Remove
							Product</button>
					</div>
				</div>
			</form>
